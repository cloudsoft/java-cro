...
output "hoodie_db_location_internal" {
  value = "jdbc:mariadb://${kubernetes_service_v1.hoodie_db_service.metadata.0.name}:${kubernetes_service_v1.hoodie_db_service.spec.0.port.0.port}/hoodiedb"
}

output "hoodie_db_host_internal" {
  value = kubernetes_service_v1.hoodie_db_service.metadata.0.name
}

output "hoodie_db_port_internal" {
  value = kubernetes_service_v1.hoodie_db_service.spec.0.port.0.port
}
